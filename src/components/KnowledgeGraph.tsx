...
export const KnowledgeGraph: React.FC<KnowledgeGraphProps> = ({ data }) => {
    ...
    node.append("circle")
      ...
      .attr("fill", d => {
        switch(d.category) {
          ...
          case 'Sự kiện': return '#f59e0b';
          case 'Cuộc họp': return '#8b5cf6';
  ...
  return (
    <div className="relative bg-slate-50 rounded-[2.5rem] border border-slate-200 overflow-hidden group">
      ...
      <div className="absolute bottom-6 left-8 z-10 flex flex-wrap gap-4 max-w-[80%]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Sự kiện</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-purple-500" />
          <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Cuộc họp</span>
        </div>
      </div>
    </div>
  );
