  ...
  const handleImportFromDocs = async () => {
    ...
    try {
      const mockOfficers = [
        ...
        {"name": "Lê Thị Kiều Oanh", "gender": "Nữ", "dob": "08/10/1988", "cccd": "74188000270", "position": "Phó Chánh Văn phòng"},
        ...
        {"name": "Võ Thành Trung", "gender": "Nam", "dob": "7/1/1985", "cccd": "74085002468", "position": "Chuyên viên"}
      ];
