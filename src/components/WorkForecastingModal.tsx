...
export const WorkForecastingModal: React.FC<WorkForecastingModalProps> = ({ isOpen, onClose }) => {
  const [activeTab, setActiveTab] = useState<'forecast' | 'genz'>('forecast');
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-1">
                    <button 
                      ...
                      className={`text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'forecast' ? 'text-indigo-600' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                      Dự báo công tác
                    </button>
                    ...
                    <button 
                      ...
                      className={`text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'genz' ? 'text-indigo-600' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                      Gen Z giải ngố
                    </button>
                  </div>
                ...
                {activeTab === 'forecast' ? (
                  ...
                  >
                    <div className="mb-8">
                      ...
                      <p className="text-slate-500 mt-2 font-medium">Cập nhật các thuật ngữ, tiếng lóng mới nhất của thế hệ Z để lãnh đạo thấu hiểu dư luận trẻ.</p>
                    </div>
                    <GenZDecoder />
                  </motion.div>
                )}
