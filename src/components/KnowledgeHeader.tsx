        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-xs font-bold text-white">Nạp Bộ Não (Apps Script v8.0)</p>
              ...
              {/* Google Contacts Sync (Admin only) */}
              {isAdmin && onSyncContacts && (
                <button 
                  onClick={onSyncContacts}
                  disabled={isSyncingContacts}
                  className="w-full flex items-center justify-between p-3 rounded-xl bg-teal-500/20 hover:bg-teal-500/30 transition-all group disabled:opacity-50 border border-teal-500/30 shadow-sm mt-3"
                >
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-teal-500/20 rounded-lg group-hover:scale-110 transition-transform">
                      <RefreshCw className={`w-4 h-4 text-teal-400 ${isSyncingContacts ? 'animate-spin' : ''}`} />
                    </div>
                    <div className="text-left">
                      <p className="text-xs font-bold text-white">Đồng bộ Danh bạ Google</p>
                      <p className="text-[9px] text-slate-400 uppercase tracking-widest">
                        Nạp liên hệ nhân sự vào bộ não
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-slate-500 group-hover:translate-x-1 transition-transform" />
